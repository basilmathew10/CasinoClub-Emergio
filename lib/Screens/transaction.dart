 ...
 History(
  ...
  Widget _buildDatePicker(BuildContext context) {
   ...
   Widget _buildPlayerList() {
    List<History> filteredPlayers = historys.where((player) {
    ...
    return ListView.builder(
      ...
      itemBuilder: (context, index) {
        History history = filteredPlayers[index];
        return Padding(
            ...
            child: Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  _buildDetailRow(Icons.games, 'Date', history.date),
                  const SizedBox(height: 10.0),
                  _buildDetailRow(Icons.star_outline_sharp, 'Game', history.game),
                ],
              ),
            ),
          ),
